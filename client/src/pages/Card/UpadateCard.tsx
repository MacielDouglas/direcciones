...
const UpadateCard = ({ id }: UpadateCardProps) => {
  const addresses = useSelector(selectAllAddresses) as Address[];
...
// import { selectAllAddresses } from "../../store/selectors/addressSelectors";
// import { selectAllCards } from "../../store/selectors/cardsSelectors";
// import type { Address } from "./types/card.types";
...
//           No se seleccionó ninguna tarjeta.
//         </h2>
//         <p>Seleccione una tarjeta para editarla..</p>
//       </div>
//     );
//   }
//   return (
