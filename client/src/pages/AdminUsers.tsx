...
//   const [newName, setNewName] = useState("");
//   const [isNameDuplicate, setIsNameDuplicate] = useState(false);
//   const [isSSMap, setIsSSMap] = useState(false);
...
//         {ungroupedUsers.length > 0 ? (
//           <>
//             <h2 className="text-2xl">Usuários no añadidos</h2>
//             <ul className="px-4 space-y-4">
//               {ungroupedUsers.map((user) => (
//                 <li key={user.id} className="flex gap-5 items-center">
//                   <img
//                     src={user.profilePicture}
//                     alt={`Foto del usuário ${user.name}`}
//                     className="w-16 h-16 object-cover rounded-full"
//                   />
//                   <div className="flex flex-col gap-1 w-3/5">
//                     <p className="text-sm text-neutral-500">
...
//                           <p
//                             className={
//                               user.isSS ? "" : "text-destaque-primary font-bold"
//                             }
//                           >
//                             NO
//                           </p>
...
//                           </label>
//                           <p
//                             className={user.isSS ? "text-destaque-primary" : ""}
//                           >
//                             SÍ
//                           </p>
//                         </div>
...
//       <div className="space-y-6 max-w-2xl mx-auto">
//         <div className="bg-zinc-100 dark:bg-zinc-800 rounded-2xl shadow p-4">
//           <h2 className="text-xl font-semibold flex items-center gap-2 mb-5 mt-3">
//             Usuários del grupo: {groupedUsers.length}
//           </h2>
//           <ul className="w-full space-y-4">
//             {groupedUsers.map((user) => (
//               <li key={user.id}>
//                 <div className="w-full text-left bg-zinc-200 dark:bg-zinc-700 hover:bg-zinc-300 dark:hover:bg-zinc-600 p-4 rounded-xl transition items-center grid grid-cols-4">
//                   <img
//                     src={user.profilePicture}
//                     alt={`Foto del usuário ${user.name}`}
//                     className="w-16 h-16 object-cover rounded-full col-span-1"
//                   />
...
//                     <p className="font-semibold truncate">{user.name}</p>
//                     {user.isSS && (
//                       <p className="text-sm font-light text-yellow-400">
//                         admin
//                       </p>
//                     )}
//                   </div>
...
//                     <button
//                       className={`bg-primary-drk text-white px-3 py-1 rounded-md text-sm inline-flex gap-2 items-center ${
//                         user.isSCards || (user.isSS && "!bg-blue-500")
//                       }`}
//                     >
//                       tarjeta {user.isSS ? <SendHorizontal /> : <Ban />}
//                     </button>
//                     <button
//                       onClick={() => handleGroupChange(user.id, "remove")}
