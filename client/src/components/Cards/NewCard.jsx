...
function NewCard() {
  ...
  return (
    <div className="text-start text-base md:text-lg w-full h-full  md:ml-[170px] lg:ml-[250px]">
        ...
        <div className="flex flex-col md:flex-row h-full w-full">
          <div className="p-6 flex flex-col gap-4 md:w-2/3 border-r md:overflow-y-auto max-h-full">
            ...
            <button
              ...
              className="mt-4 px-6 py-2 border border-secondary hover:bg-secondary hover:text-primary transition-colors text-sm lg:text-lg disabled:border-gray-300 disabled:text-gray-300 disabled:cursor-not-allowed disabled:hover:bg-primary"
