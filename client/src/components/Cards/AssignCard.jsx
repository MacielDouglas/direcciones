...
//   return (
//     <div className="min-h-screen bg-details p-3 md:p-10 flex flex-col justify-center">
//       <div>
...
//         {cards && (
//           <div>
//             <p>Atualmente há {cards.length} cartões disponíveis.</p>
//             <p>Temos {users?.length} usuários registrados.</p>
//           </div>
//         )}
//         <div className="h-96">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {cards.map((card) => (
              <motion.li
                ...
                style={{
                  borderColor: cardColors[card.id],
                  backgroundColor:
                    selectedCard === card.id
                      ? cardColors[card.id]
                      : "transparent",
