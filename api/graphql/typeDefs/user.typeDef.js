...
type Query {
    ...
    getFirebaseConfig: EncryptedConfig
    logoutUser: LogoutUserResponse
}

type Mutation {
    createUser(user: NewUserInput!): UserMutationResponse!
    updateUser(id: ID!, action: String!, updates: UpdateUserInput!): UserResponse!
    deleteUser(id: ID!): UserMutationResponse!
    loginWithGoogle(user: UserGoogleInput!): UserResponse!
}
